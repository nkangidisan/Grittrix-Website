...
export const productsList: Product[] = [
  {
    ...
    icon: Cpu,
    imageUrl: '/media/product-core.svg', 
    features: [
  ...
  },
  {
    ...
    icon: Stethoscope,
    imageUrl: '/media/product-health.svg', 
    features: [
  ...
  },
  {
    ...
    icon: Store,
    imageUrl: '/media/product-retail.svg', 
    features: [
  ...
  },
  {
    ...
    icon: Sprout,
    imageUrl: '/media/product-agro.svg', 
    features: [
  ...
  },
  {
    ...
    icon: GraduationCap,
    imageUrl: '/media/product-learn.svg', 
    features: [
