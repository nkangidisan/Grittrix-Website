...
// Applying standard Next.js typing for page props
export default function ProductDetailPage({ params }: { params: { productId: string } }) {
  ...
  return (
    <>
      {/* Simplified Header - direct title, no PageHeader component */}
      <section className="py-12 md:py-16 bg-secondary/10 border-b border-border">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {product.tagline && <p className="text-lg text-foreground/80 max-w-3xl">{product.tagline}</p>}
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <p className="text-lg text-foreground/80 leading-relaxed mb-8">
            {product.description} {/* Display full description */}
          </p>
          
          <div className="bg-card p-6 rounded-lg shadow-md">
             <p className="text-foreground/70 mb-4">
              For a comprehensive overview of all our offerings, please visit our main products page or contact our expert team for more information.
            </p>
