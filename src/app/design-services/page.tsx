...
const portfolioItems = [
  ...
  { id: '2', title: 'RetailSense E-commerce', category: 'Retail Mobile App', imageUrl: '/media/portfolio-retail-ecommerce.png', altText: 'RetailSense mobile e-commerce app interface illustration' },
