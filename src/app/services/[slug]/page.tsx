...
const serviceDetailsData: { 
  [key: string]: {
    ...
    features: string[];
    imageHint: string;
    icon?: React.ElementType; // Optional: if we want to show icon on detail page too
  } 
} = {
    'ai-dashboards': { 
        ...
        imageHint: 'data dashboard screen' 
    },
    'forecasting': { 
        ...
        imageHint: 'financial graphs forecast' 
    },
    'prediction-models': {
        ...
        imageHint: 'predictive analytics charts'
    },
    'custom-applications': {
        ...
        imageHint: 'web mobile app interface'
    },
    'cloud-services': {
    ...
    'integrations': {
        ...
        imageHint: 'connected systems flowchart'
    },
    'data-analytics-services': {
        ...
        imageHint: 'data analysis process'
    },
    'training-support': {
        ...
        imageHint: 'team training workshop'
    }
};
...
export default function ServiceDetailPage({ params }: { params: { slug: string } }) {
  ...
  if (!details) { // Check details first, as it's the primary source for this page
    notFound();
  }
  ...
  const IconComponent = serviceInfoFromList?.icon; // Get icon from servicesList if available
