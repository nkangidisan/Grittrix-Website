...
const serviceDetailsData: { 
  [key: string]: {
    ...
    'forecasting': { 
        ...
        imageUrl: 'https://placehold.co/1080x608.png', 
        imageHint: 'forecast graph finance' 
    },
    'prediction-models': {
        ...
        imageUrl: 'https://placehold.co/1080x608.png', 
        imageHint: 'prediction chart medical'
    },
    'custom-applications': {
    ...
    'cloud-services': {
        ...
        imageUrl: 'https://placehold.co/1080x608.png', 
        imageHint: 'cloud server network'
    },
    'integrations': {
        ...
        imageUrl: 'https://placehold.co/1080x608.png', 
        imageHint: 'systems integration connect'
    },
...
export async function generateMetadata(
  ...
  const absoluteImageUrl = service.imageUrl.startsWith('http') ? service.imageUrl : `https://www.grittrix.com${service.imageUrl}`;
...
export default function ServiceDetailPage({ params }: { params: { slug: string } }) {
  ...
  const imageAltText = details.imageHint ? `${details.title} - ${details.imageHint}` : details.title;
